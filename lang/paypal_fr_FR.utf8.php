...
$lang['paypal']['WARNING: If you enter an amount below, make sure that it is not lower than the amount of the option you\'ve selected.'] = 'ATTENTION : si vous entrez un montant ci-dessous, assurez-vous qu\'il ne soit pas inférieur au montant de l\'option que vous avez sélectionnée.';

// ../templates/default/paypal_form.tpl:75 
$lang['paypal']['No predefined amounts have been configured yet.'] = 'Aucun montant prédéfini n\'a encore été configuré.';

// ../templates/default/paypal_form.tpl:6 
$lang['paypal']['<strong>Payment coult not work</strong>: An error occured (that has been logged) while loading Paypal preferences from database.<br/>Please report the issue to the staff.'] = '<strong>Le paiement ne peut fonctionner</strong> : une erreur (qui a été enregistrée) est survenue lors du chargement des préférences Paypal depuis la base de données.<br/>Merci de rapporter ce problème aux membres du bureau.';
...
$lang['paypal']['Paypal identifier:'] = 'Identifiant Paypal';

// ../templates/default/paypal_preferences.tpl:48 
$lang['paypal']['Error: no predefined amounts found.'] = 'Erreur : aucun montant prédéfini trouvé.';

// ../templates/default/paypal_form.tpl:124 
$lang['paypal']['The amount you\'ve entered is lower than the minimum amount for the selected option.\\nPlease choose another option or change the amount.'] = 'Le montant que vous avez entré est inférieur au montant minimum de l\'option sélectionnée.\\nVeuillez choisir une autre option ou entrer un nouveau montant.';
...
$lang['paypal']['Predefined amounts cannot be loaded, that is not a critical error.'] = 'Les montants prédéfinis n\'ont pas pu être chargés, cette erreur n\'est pas crtitique.';

// ../templates/default/menu.tpl:5 
$lang['paypal']['Paypal History'] = 'Historique Paypal';

// ../templates/default/paypal_form.tpl:121 
$lang['paypal']['Please enter an amount.'] = 'Veuillez entrer un montant.';
...
// ../templates/default/paypal_success.tpl:4 
$lang['paypal']['Your paypal payment was successful. Some details are shown below:'] = 'Votre paiement paypal a été effectué avec succès. Quelques détails concernant la transaction sont affichés ci-dessous :';
